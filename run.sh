...
python3 -m main 5 designs/test-designs/test_2.v --sv  --auto-plan --llm-provider deepseek --coi --strategy directed
#python3 -m main 5 designs/test-designs/test_2.v --sv   --coi
